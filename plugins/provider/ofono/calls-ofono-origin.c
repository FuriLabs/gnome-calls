...
{
  CallsOfonoOrigin *self = CALLS_OFONO_ORIGIN (object);
  CallsMMOrigin *self2 = CALLS_MM_ORIGIN (object);
  ...
  g_signal_connect_object (self2->mm_obj, "notify::modem3gpp-ussd",
                           G_CALLBACK (call_mm_ussd_changed_cb), self,
                           G_CONNECT_SWAPPED);

  call_mm_ussd_changed_cb (self2);
